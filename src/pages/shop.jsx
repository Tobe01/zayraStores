          ...
          <div className="shop-container">
            <div className="shop-container-sub">
              ...
              <div className="trend1">
                <button onClick={showShopItems} style={{backgroundColor: shopItems ? 'grey' : 'white', color: shopItems ? 'white' : 'black'}} className="fashion" data-item>
                  AARON MARTINEZ
                </button>
                <button onClick={showMensItems} style={{backgroundColor: mensItems ? 'grey' : 'white', color: mensItems ? 'white' : 'black'}}>Men's</button>
                <button onClick={showKidsItems} style={{backgroundColor: kidsItems ? 'grey' : 'white', color: kidsItems ? 'white' : 'black' }} >Kids</button>
                <button onClick={showWomensItems} style={{backgroundColor: womensItems ? 'grey' : 'white', color: womensItems ? 'white' : 'black'}}>Women's</button>
              </div>
            </div>
            ...
            <div className="main-shopItems">
              ...
              <div>
                ...
                <div className="item-container fade-in-up">
                  {shopItems && (shopData.map((shopItems) => {
                    return (
                      <ShopCard
                        key={shopItems.id}
                ...
                <div className="mensItem-container fade-in-up">
                  { mensItems && (mensData.map((mensItem)=>{
                    return(
                      <MenCard
                        key={mensItem.id}
                ...
                <div className="kidsItem-container fade-in-up">
                  { kidsItems && (kidsData.map((kidsItem)=>{
                    return(
                      <KidsCard
                        key={kidsItem.id}
                ...
                <div className="womensItem-container fade-in-up">
                  { womensItems && (womensData.map((womensItem)=>{
                    return(
                      <WomensCard
                        key={womensItem.id}
